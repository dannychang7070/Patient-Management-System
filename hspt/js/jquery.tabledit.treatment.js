    ...
    $.fn.Tabledit = function(options) {
        ...
        if (settings.editButton) {
            ...
            $table.on('click', 'button.tabledit-edit-button', function(event) {
                ...
                old_part = $(this).parent().parent().parent().parent().find("input[name='part']").val();
                old_name = $(this).parent().parent().parent().parent().find("input[name='disease']").val();
            });
            ...
            $table.on('click', 'button.tabledit-save-button', function(event) {
                ...
                var new_part = $(this).parent().parent().parent().find("input[name='part']").val();
                var new_name = $(this).parent().parent().parent().find("input[name='disease']").val();
                var td_index = $(this).parent().parent().parent().prop('id');
                $.post({
