...
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='分部病患';
...
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='就醫紀錄';
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='病歷商品';
...
CREATE TABLE IF NOT EXISTS `CaseTreatment` (
  ...
  `updateTime` datetime DEFAULT NULL COMMENT '更新時間',
  `isDelete` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否刪除'
) ENGINE=InnoDB AUTO_INCREMENT=140 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='治療紀錄';
...
(137, 69, 5, 3, 5, 'admin', NULL, 100, 100, '2018-06-09 23:47:42', NULL, 0),
...
(4, 1, '瑜珈墊', 'M', '2017-08-12 19:35:54', 5, 100, -3, 1, 'admin'),
...
CREATE TABLE IF NOT EXISTS `MerchandiseRecord` (
  ...
  `status` int(1) NOT NULL COMMENT '是否啟用'
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品進貨紀錄';

--
-- 資料表的匯出資料 `MerchandiseRecord`
--

INSERT INTO `MerchandiseRecord` (`ID`, `Merchandise_ID`, `time`, `type`, `amount`, `cost`, `remaining`, `User_account1`, `User_account2`, `createTime`, `deleteTime`, `status`) VALUES
(1, 3, '2018-05-01 23:00:00', 1, 5, 100, 0, 'admin', '', '2018-05-02 00:09:04', '2018-05-02 00:12:48', 1),
(2, 3, '2018-05-01 23:00:00', 1, 5, 100, 5, 'admin', 'admin', '2018-05-02 00:09:41', '2018-05-02 00:21:43', 0),
(3, 4, '2018-05-26 23:21:22', 1, 10, 1000, 0, 'admin', '', '2018-05-26 23:21:38', '0000-00-00 00:00:00', 1),
(4, 6, '2018-05-26 23:46:22', 1, 5, 500, 0, 'admin', '', '2018-05-26 23:51:44', '0000-00-00 00:00:00', 1),
(5, 6, '2018-05-27 00:08:58', 2, -3, 300, 0, 'admin', '', '2018-05-27 00:10:21', '0000-00-00 00:00:00', 1),
(6, 6, '2018-05-27 00:10:29', 1, 8, 800, 0, 'admin', '', '2018-05-27 00:13:29', '0000-00-00 00:00:00', 1),
(7, 6, '2018-05-27 00:13:36', 1, 3, 480, 2, 'admin', '', '2018-05-27 00:14:55', '0000-00-00 00:00:00', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='病患資料';
...
--
ALTER TABLE `CaseDepartment`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '序號 (PK)',AUTO_INCREMENT=103;
--
-- 使用資料表 AUTO_INCREMENT `CaseHistory`
--
ALTER TABLE `CaseHistory`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '就醫編號 (PK)',AUTO_INCREMENT=70;
--
-- 使用資料表 AUTO_INCREMENT `CaseMerchandise`
--
ALTER TABLE `CaseMerchandise`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '病歷商品編號 (PK)',AUTO_INCREMENT=41;
--
-- 使用資料表 AUTO_INCREMENT `CaseMerchandiseRecord`
--
ALTER TABLE `CaseMerchandiseRecord`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '病歷關聯商品批號ID',AUTO_INCREMENT=15;
--
-- 使用資料表 AUTO_INCREMENT `CaseTreatment`
--
ALTER TABLE `CaseTreatment`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '治療紀錄編號 (PK)',AUTO_INCREMENT=140;
--
...
--
ALTER TABLE `MerchandiseRecord`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '進貨編號 (PK)',AUTO_INCREMENT=44;
--
-- 使用資料表 AUTO_INCREMENT `Patients`
--
ALTER TABLE `Patients`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '病患編號 (PK)',AUTO_INCREMENT=74;
--
