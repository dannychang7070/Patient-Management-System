...
CREATE TABLE IF NOT EXISTS `CaseHistory` (
  ...
  `User_account3` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '更新者帳號',
  `createTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
  `updateTime` datetime NOT NULL COMMENT '更新時間'
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='就醫紀錄';
...
(13, 1, '2017-04-05 23:10:00', '', 'admin', 'test311', '', '2017-04-05 23:08:39', '0000-00-00 00:00:00'),
(15, 1, '2017-06-18 23:50:00', '', 'test41', 'test312', '', '2017-06-18 23:58:03', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `CaseMerchandise` (
  ...
  `merchandiseName` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '商品名稱',
  `merchandiseSize` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '商品規格',
  ...
  `User_account2` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '更新者帳號',
  `createTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
  `updateTime` datetime NOT NULL COMMENT '更新時間',
  `isDelete` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否刪除'
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='病歷商品';

--
-- 資料表的匯出資料 `CaseMerchandise`
--

INSERT INTO `CaseMerchandise` (`ID`, `CaseHistory_ID`, `Merchandise_ID`, `merchandiseName`, `merchandiseSize`, `MerchandiseRecord_ID`, `cost`, `amount`, `price`, `charge`, `User_account1`, `User_account2`, `createTime`, `updateTime`, `isDelete`) VALUES
(2, 13, 1, '按摩藥膏', '5ml', 0, 0, 2, 100, 99, 'dapartTherapist1', 'admin', '2017-04-05 23:08:39', '2017-07-08 22:58:42', 0),
(4, 15, 1, '按摩藥膏', '5ml', 0, 0, 1, 100, 99, 'test41', 'test312', '2017-06-18 23:58:03', '0000-00-00 00:00:00', 0);
...
CREATE TABLE IF NOT EXISTS `CaseTreatment` (
  ...
  `diseaseName` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT '症狀名稱',
  `diseasePart` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '身體部位',
  `TreatmentPrice_ID` int(11) NOT NULL COMMENT '治療包裝價格(FK)',
  `treatmentType` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '治療類型',
  `Treatment_ID` int(11) NOT NULL COMMENT '治療編號 (FK)',
  `treatmentName` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT '治療名稱',
  `User_account1` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '建立者帳號 (FK)',
  `User_account2` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '更新者帳號',
  `price` int(11) NOT NULL COMMENT '當時定價',
  `charge` int(11) NOT NULL COMMENT '實收金額',
  ...
  `updateTime` datetime NOT NULL COMMENT '更新時間',
  `isDelete` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否刪除'
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='治療紀錄';

--
-- 資料表的匯出資料 `CaseTreatment`
--

INSERT INTO `CaseTreatment` (`ID`, `CaseHistory_ID`, `Disease_ID`, `diseaseName`, `diseasePart`, `TreatmentPrice_ID`, `treatmentType`, `Treatment_ID`, `treatmentName`, `User_account1`, `User_account2`, `price`, `charge`, `createTime`, `updateTime`, `isDelete`) VALUES
(16, 13, 1, '瘀青', '手', 1, '徒手治療', 1, '按摩', 'test41', 'admin', 100, 90, '2017-06-18 18:44:34', '2017-07-08 22:58:42', 0),
(18, 15, 1, '瘀青', '手', 1, '', 1, '按摩', 'test41', 'test312', 100, 99, '2017-06-18 23:58:03', '0000-00-00 00:00:00', 0);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='治療症狀';
...
CREATE TABLE IF NOT EXISTS `Merchandise` (
  ...
  `User_account1` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '建立者帳號 (FK)'
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品';
...
(3, 1, '瑜珈墊', 'S', '0000-00-00 00:00:00', 0, 0, 0, 0, 'admin');
...
(3, 'patient01', '2016-10-01', '男', '0800000123', '', '台南市佳里區公園路262號', ''),
...
CREATE TABLE IF NOT EXISTS `Treatment` (
  ...
  `status` int(11) NOT NULL COMMENT '是否啟用(0=不可用 1=可用)'
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='治療方式';

--
-- 資料表的匯出資料 `Treatment`
--

INSERT INTO `Treatment` (`ID`, `Department_ID`, `TreatmentType_ID`, `name`, `status`) VALUES
(1, 1, 1, '按摩', 1),
(2, 1, 2, '拉筋', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='治療價格';
...
CREATE TABLE IF NOT EXISTS `TreatmentType` (
  ...
  `status` int(11) NOT NULL COMMENT '是否啟用'
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='治療類型';
...
--
ALTER TABLE `CaseHistory`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '就醫編號 (PK)',AUTO_INCREMENT=16;
--
-- 使用資料表 AUTO_INCREMENT `CaseMerchandise`
--
ALTER TABLE `CaseMerchandise`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '病歷商品編號 (PK)',AUTO_INCREMENT=5;
--
-- 使用資料表 AUTO_INCREMENT `CaseTreatment`
--
ALTER TABLE `CaseTreatment`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '治療紀錄編號 (PK)',AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `Disease`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '症狀編號 (PK)',AUTO_INCREMENT=5;
--
-- 使用資料表 AUTO_INCREMENT `Merchandise`
--
ALTER TABLE `Merchandise`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '商品編號 (PK)',AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `Treatment`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '治療編號 (PK)',AUTO_INCREMENT=3;
--
-- 使用資料表 AUTO_INCREMENT `TreatmentPrice`
--
ALTER TABLE `TreatmentPrice`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '價格編號(PK)',AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `Treatment`
  ADD CONSTRAINT `Treatment_Departmemt` FOREIGN KEY (`Department_ID`) REFERENCES `Department` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
