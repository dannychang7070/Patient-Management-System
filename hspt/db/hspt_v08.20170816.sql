...
CREATE TABLE IF NOT EXISTS `Treatment` (
  ...
  `status` int(11) NOT NULL COMMENT '是否啟用(0=不可用 1=可用)'
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='治療方式';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='治療價格';
...
--
ALTER TABLE `Treatment`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '治療編號 (PK)',AUTO_INCREMENT=4;
--
-- 使用資料表 AUTO_INCREMENT `TreatmentPrice`
--
ALTER TABLE `TreatmentPrice`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '價格編號(PK)',AUTO_INCREMENT=6;
--
