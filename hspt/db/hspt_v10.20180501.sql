...
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='分部病患';
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='就醫紀錄';
...
(36, 7, '2018-02-13 00:00:00', '', 'admin', 'test311', NULL, '2018-02-13 23:23:32', NULL);
...
CREATE TABLE IF NOT EXISTS `CaseTreatment` (
  ...
  `updateTime` datetime DEFAULT NULL COMMENT '更新時間',
  `isDelete` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否刪除'
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='治療紀錄';
...
(50, 36, 5, 3, 4, 'admin', NULL, 100, 100, '2018-02-13 23:23:33', NULL, 0),
(51, 36, 1, 2, 2, 'admin', NULL, 100, 90, '2018-02-13 23:23:33', NULL, 0);
...
CREATE TABLE IF NOT EXISTS `Merchandise` (
  ...
  `User_account1` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '建立者帳號 (FK)'
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品';
...
(1, 1, '按摩藥膏', '5ml', '2016-10-02 00:00:00', 5, 35, 15, 0, 'admin'),
(3, 1, '瑜珈墊', 'S', '0000-00-00 00:00:00', 0, 0, 6, 1, 'admin'),
(4, 1, '瑜珈墊', 'M', '2017-08-12 19:35:54', 5, 100, 4, 1, 'admin'),
(5, 1, 'test', 'M', '2018-04-15 13:24:05', 5, 99, 1, 1, 'admin');
...
CREATE TABLE IF NOT EXISTS `MerchandiseRecord` (
  ...
  `status` int(1) NOT NULL COMMENT '是否啟用'
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品進貨紀錄';
...
(1, 3, '2018-05-01 23:00:00', 1, 5, 100, 0, 'admin', '', '2018-05-02 00:09:04', '2018-05-02 00:12:48', 0),
(2, 3, '2018-05-01 23:00:00', 1, 5, 100, 0, 'admin', 'admin', '2018-05-02 00:09:41', '2018-05-02 00:21:43', 0);
...
) ENGINE=InnoDB AUTO_INCREMENT=73 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='病患資料';
...
--
ALTER TABLE `CaseDepartment`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '序號 (PK)',AUTO_INCREMENT=102;
--
-- 使用資料表 AUTO_INCREMENT `CaseHistory`
--
ALTER TABLE `CaseHistory`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '就醫編號 (PK)',AUTO_INCREMENT=37;
--
...
--
ALTER TABLE `CaseTreatment`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '治療紀錄編號 (PK)',AUTO_INCREMENT=52;
--
...
--
ALTER TABLE `Merchandise`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '商品編號 (PK)',AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `Patients`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '病患編號 (PK)',AUTO_INCREMENT=73;
--
