...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='分部病患';
...
(72, 'zhiHong', 'S0000000', '2018-01-01', '7', '0800000111', '', 'Taiwan', 'no more note\none note');
...
--
ALTER TABLE `CaseDepartment`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '序號 (PK)',AUTO_INCREMENT=101;
--
